...
<body>
	...
	<div id="content">
		...
		<div class="panel">
			...
			<span id="lab"><font style="color:red;font-size:14px">&emsp;&emsp;&emsp;<%=prop%></font></span>
			<div class="group">
				<label id="plab">密码</label> <input type="password" placeholder="密码" id="pwd" name="password">
			</div>
			<!--       提示信息 -->
